...
//        let neoInstanceName = this.desktopInstanceName;
        ...
        try {
            ...
            let arrayStoreSize = this._readNumberProperty(record,"arrayStoreSize");
            let logicalLogSize = this._readNumberProperty(record,"logSize");
            let nodeStoreSize = this._readNumberProperty(record,"nodeStoreSize");
            let propertyStoreSize = this._readNumberProperty(record,"propStoreSize");
            let relationshipStoreSize = this._readNumberProperty(record,"relStoreSize");
            let stringStoreSize = this._readNumberProperty(record,"stringStoreSize");
            let totalStoreSize = this._readNumberProperty(record,"totalStoreSize");
            //
            let countStoreSize = this._readNumberProperty(record,"countStoreSize");
            let labelStoreSize = this._readNumberProperty(record,"labelStoreSize");
            let indexStoreSize = this._readNumberProperty(record,"indexStoreSize");
            let schemaStoreSize = this._readNumberProperty(record,"schemaStoreSize");
