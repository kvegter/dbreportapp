...
class NeoAccessor {
    ...
    async _initNeo(neoHost, neoPort, neoUser, neoPassword, useEncrypted) {
        let prms;
        try {
            ...
            this.neo4jApiUrl = "bolt" + "://" + this.neoHost + ":" + this.neoPort;
...
//        console.log("after show")
    ...
    processConnectForm() {
        ...
        this._initNeo(lhost, lport, lusername, lpassword, lencrypted);
