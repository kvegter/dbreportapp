    ...
    __getMandatoryConstraints(entity) {
        ...
        for (let uu of this.dbinfo.constraints) {
            if (nac.neodb.majorVersion < 5) {
                ...
                if (uu.type.indexOf("PROPERTY_EXISTENCE") > -1) {
                    let label = uu.labelsOrTypes[0];
                    let props = uu.properties;
                    let cdef = { name : uu.name ,
                        label : [label],
                        properties : props}
                    uc.push(cdef);
...
//        summaryhtml += "<div style='height : 200px'></div>";
        ...
        if (aData.indexes && aData.indexes.length > 0) {
            ...
            if (nac.neodb.majorVersion < 4) {
                ...
                for (let i = 0; i < aData.indexes.length; i++) {
                    ...
                    if (i == 0) {
                        // header
                        indexeshtml += "<table class='ui celled table'><thead><tr><th style='width: 100px;'>Id</th><th style='width: 250px;'>Name</th><th style='width: 150px;'>State</th><th style='width: 150px;'>population %</th><th style='width: 200px;'>owning constraint</th><th style='width: 150px;'>Type</th><th style='width: 150px;'>Entity Type</th><th style='width: 150px;'>Labels or Types</th><th style='width: 150px;'>Properties</th><th>Provider</th></tr></thead><tr>";
                    }
                    indexeshtml += "<tr>";
                    indexeshtml += "<td>";
                    indexeshtml += curi.id.low;
                    ...
                    indexeshtml += this._nuvl(curi.owningConstraint,"");
                    indexeshtml += "</td>";
                    indexeshtml += "<td>";
                    indexeshtml += curi.type;
                    indexeshtml += "</td>";
                    ...
                    indexeshtml += "</td>";
                    indexeshtml += "<td>";
                    indexeshtml += this._nuvl(curi.labelsOrTypes, "");
                    indexeshtml += "</td>";
                    indexeshtml += "<td>";
                    indexeshtml += this._nuvl(curi.properties, "");
                    indexeshtml += "</td>";
                    indexeshtml += "<td>";
                    indexeshtml += curi.indexProvider;
                    indexeshtml += "</td>";
        ...
        if (aData.constraints && aData.constraints.length > 0) {
            ...
            for (let i = 0 ; i < aData.constraints.length; i++) {
                ...
                if (nac.neodb.majorVersion < 5) {
                    ...
                    if (i == 0) {
                        // header
                        constraintshtml += "<table class='ui celled table'><thead><tr><th style='width: 100px;'>id</th><th style='width: 250px;'>Name</th><th style='width: 250px;'>Type</th><th style='width: 250px;'>Entity Type</th><th style='width: 250px;'>Labels or Types</th><th style='width: 250px;'>properties</th><th >Owned Index</th></tr></thead><tr>";
                    }
                    constraintshtml += "<tr>";
                    constraintshtml += "<td>";
                    constraintshtml += curi.id.low;
                    constraintshtml += "</td>";
                    constraintshtml += "<td>";
                    constraintshtml += curi.name;
                    constraintshtml += "</td>";
                    constraintshtml += "<td>";
                    constraintshtml += curi.type;
                    constraintshtml += "</td>";
                    constraintshtml += "<td>";
                    constraintshtml += curi.entityType;
                    constraintshtml += "</td>";
                    constraintshtml += "<td>";
                    constraintshtml += curi.labelsOrTypes;
                    constraintshtml += "</td>";
                    constraintshtml += "<td>";
                    constraintshtml += curi.properties;
                    constraintshtml += "</td>";
                    constraintshtml += "<td>";
                    constraintshtml += this._nuvl(curi.ownedIndex, "");
                    constraintshtml += "</td>";
                    constraintshtml += "</tr>";
                }
            }
    ...
    _getConstraintType(aString) {
        // console.log("_getConstraintType: " + aString)
        if (aString.indexOf("IS NODE KEY")> -1) {
            return "NODE KEY";
        } else if (aString.indexOf("exists(") > -1) {
            return "MANDATORY";
        } else if (aString.indexOf("PROPERTY_EXISTENCE") > -1) {
            return "MANDATORY";
