            ...
            prms.then( function(ctx) {
                ...
                if (current.graphdb) {
                    ...
                    if (initDriver == true) {
                        ...
                        // init filter tab
                        current._initFilter("label", false);
                        current._initFilter("rel", false);
...
//        summaryhtml += "<div style='height : 200px'></div>";
  ...
  _setContext(aCtx) {
    ...
    handleCountProps(){
        let lp = document.getElementById("analyzeLabelProps");
        let lr = document.getElementById("analyzeRelProps");
        let lc = document.getElementById("analyzeLabelCombo");
        let btCountFilterLabel  = document.getElementById("btCountFilterLabel");
        let btCountFilterRelationship  = document.getElementById("btCountFilterRelationship");
        let btCountTreshold = document.getElementById("btCountTreshold");
        // countTreshold
        if (lp.checked || lr.checked || lc.checked ) {
        ...
        // btCountFilterLabel
        if (lp.checked ) {
            this._enableElement("btCountFilterLabel")
        } else {
            this._disableElement("btCountFilterLabel")
        }
        // btCountFilterRelationship
        if (lr.checked ) {
            this._enableElement("btCountFilterRelationship")
        } else {
            this._disableElement("btCountFilterRelationship")
        }
    }
